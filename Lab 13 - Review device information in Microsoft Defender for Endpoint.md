# Lab: Review Device Information for SEA-WS1 in Microsoft Defender for Endpoint

This lab walks you through using **Microsoft Defender for Endpoint** to review detailed device information for **SEA-WS1**, with a focus on:
...
3. In the device list, use the search box to search for:  
   `SEA-WS1`
4. Select the device **SEA-WS1** from the results to open the device details page.

---

## Step 3: Review Inventory Information

1. On the **SEA-WS1** device page, select the **Inventory** tab.
...
1. On the **SEA-WS1** device page, select the **Vulnerabilities** tab.
...
1. On the **SEA-WS1* device page, select the **Security recommendations** tab.
...
1. Confirm that inventory data is visible for **SEA-WS1**.
...
- [ ] The **SEA-WS1** device is visible in Microsoft Defender for Endpoint.
...
You have reviewed the **Inventory**, **Vulnerabilities**, and **Security recommendations** for the **SEA-WS1** device in Microsoft Defender for Endpoint and understand its current security posture.
